...
if ($installer->getConnection()->isTableExists($installer->getTable('tmcore/module')) != true) {
    /**
     * Create table 'tmcore/module'
     */
    $typeText = defined('Varien_Db_Ddl_Table::TYPE_TEXT') ? Varien_Db_Ddl_Table::TYPE_TEXT : Varien_Db_Ddl_Table::TYPE_VARCHAR;
